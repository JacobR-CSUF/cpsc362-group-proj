  ...
  return (
    <div className="min-h-screen bg-green-100">
      ...
      <div className="w-full px-2 py-10 sm:px-4">
        <div className="mb-10 flex flex-col items-center gap-3">
          <div className="relative">
            ...
            <button
              ...
              className="absolute -bottom-0 -right-0 flex h-10 w-10 items-center justify-center rounded-full bg-green-500 hover:bg-green-600 shadow"
            >
              <img
                src="https://img.icons8.com/ios/50/ffffff/pen.png"
                alt="Edit"
                className="h-6 w-6"
              />
            </button>
        ...
        {postsLoading && <p className="text-center text-green-700">Loading posts...</p>}
